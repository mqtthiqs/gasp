...
module Make (Syntax : Sig.Camlp4Syntax) = struct
  ...
  let rec build_rewrites sigma = function
    ...
    | MType(<:ctyp<$_$>>, _) -> raise (Loc.Exc_located (Loc.ghost, Unimplemented)) (* TODO *)
  ...
  and rewrite_modtype path sigma : Ast.module_type -> Ast.module_expr = function
    ...
    | <:module_type@loc< '$_$ >>
      -> raise (Loc.Exc_located (loc, Unimplemented)) (* TODO complete *)
  ...
  EXTEND Gram
    ...
    module_expr:
      [ [
	"types"; "of"; e = module_type ->
	rewrite_modtype (fun x -> <:ident< $lid:x$ >>) Sigma.empty e
      |	"types"; "of"; e = module_type; "with"; r = modtype_rewrite ->
