  ...
  let ocaml_keywords =
    ...
    List.iter (fun s -> Hashtbl.add h s ())
      [
        ...
        "as";  "elif";"globalor";  "with";"assert";"else";
        "if"; "pass"; "yield"; "break"; "except"; "import"; "print";
        "class"; "exec"; "in"; "raise";
...

{
  ...
  let () = Pp.add_pp_environment "python-tt" python_alltt
  let () = Pp.add_pp_environment "python-sf" python_sf
  let () = Pp.add_pp_environment "python" python_sf
