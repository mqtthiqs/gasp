...

{
  ...
  let () = Pp.add_pp_environment "scala-tt" scala_alltt
  let () = Pp.add_pp_environment "scala-sf" scala_sf
  let () = Pp.add_pp_environment "scala" scala_sf
  ...
  let () = Pp.add_pp_macro "scala-tt" texttt
  let () = Pp.add_pp_macro "scala-sf" textsf
  let () = Pp.add_pp_macro "scala" textsf
}
