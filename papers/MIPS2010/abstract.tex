...
object $t'$ using a $\textit{putback}$ function $\sigma(t, w)$. 
...
\remtext{Fri Jun 18, 2010 1:38 PM. Il faut différencier deux arbres de
  ...
  que l'on peut utiliser pour construire $\Delta$. Référence sur 
  la littérature sur les distances d'édition entre arbres. Discussion
  sur l'élaboration de patchs de haut niveau (comme le renommage etc). }
