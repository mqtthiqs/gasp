...
val pr_str : string printing_fun
val pr_int : int printing_fun
val pr_opt : 'a printing_fun -> 'a option printing_fun
val pr_opt_under : 'a printing_fun -> 'a option printing_fun
