...
framework~\cite{appel1999proof} \ldots %TODO ATP
...
$\jea\Delta\Gamma A {A'}$.
% TODO expliquer, et commenter reduction des fonctions ou pas,
% conv. typee ou pas
...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \infer[FAppVar]{
      ...
      \jf\Delta\Gamma {\app {\var x} S} {\Delta'} {\app {\var x} {S'}} P
    }
    ...
    \infer[FAppConst]{
      ...
      \jf\Delta\Gamma {\app {\cst c} S} {\mapadd{\Delta'}{\meta X}{(\Gamma'\vdash
    ...
    \infer[FAppEval]{
      ...
      \jf\Delta\Gamma {\app {\fct f} S} {\Delta'} {F'} P
    }
  ...
  \begin{mathpar}
    ...
    \infer[SNil]{ }{
      \jl\Delta\Gamma P \spinenil \Delta \spinenil P
    }
  \end{mathpar}
...
% TODO verif qu'on parle bien de LF normal
\begin{lemma}
...
\begin{figure}
  \fbox{$\jcc\Delta\Gamma A T S {\Delta'} F P$}
  \qquad
  {Term evaluation}
  ...
  \begin{mathpar}
    \infer[TLam]{
      ...
      \and
      \jcc{\Delta'}\Gamma{\gsubst {A_2} {\msubst x {M'}}}{\gsubst T
        {\msubst x {M'}}} S {\Delta''} F P
    }{
    ...
    \infer[TAtom]{
      ...
      \jcc\Delta\Gamma P U \spinenil {\Delta''} {F'} P
    }
  \end{mathpar}
...
\begin{theorem}
  If $\mr$ well-constructed, and $\commit\mr F = \mmr$, then
  $\checkout{\mmr}$ is a value.
\end{theorem}
