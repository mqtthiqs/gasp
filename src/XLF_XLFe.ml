...
let rec obj = function
  ...
  | XLF.OVar(x,l,XLF.FProd(y,a,b)) -> 
      XLFe.OLam(y, fam a, obj (XLF.OVar(x, l@[XLF.OVar(name_of y, [], a)], b)))
  ...
  | XLF.OConst(c,l,XLF.FProd(y,a,b)) -> 
      XLFe.OLam(y, fam a, obj (XLF.OConst(c, l@[XLF.OVar(name_of y, [], a)], b)))
  ...
  | XLF.OApp(t,l,XLF.FProd(y,a,b)) -> 
      XLFe.OLam(y, fam a, obj (XLF.OApp(t, l@[XLF.OVar(name_of y, [], a)], b)))
